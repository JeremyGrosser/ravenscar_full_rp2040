...
package System.BB.Board_Parameters is
   ...
   XOSC_Frequency : constant XOSC_Frequency_Range := 12_000_000;
   ...
   XOSC_Startup_Delay_Mult : constant := 1;
   ...
   PLL_Sys_Post_Div_1    : constant POSTDIV_Range := 6;
   PLL_Sys_Post_Div_2    : constant POSTDIV_Range := 2;
   ...
   PLL_USB_Post_Div_1    : constant POSTDIV_Range := 5;
   PLL_USB_Post_Div_2    : constant POSTDIV_Range := 2;
